...
public class SelectScene : MonoBehaviour
{
    ...
    IEnumerator Start()
    {
        ...
        SoundManager.I?.PlayBGM("Track5",2.4f);
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (Physics.Raycast(ray, out hit))
            {
                ...
                MouseDown(hit.collider.gameObject);
            }
        }
    }
    Tween camTween1;
    void MouseDown(GameObject go)
    {
        if (!setup) return;
        if (go == null) return;
    ...
    IEnumerator NextScene()
    {
        ...
        yield return YieldInstructionCache.WaitForSeconds(0.8f);
        SceneChanger.I?.LoadSceneAsync(3);
    }
